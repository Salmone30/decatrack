...
  createWebSocket () {
    // ATTENZIONE: Le righe seguenti che determinavano l'indirizzo dal browser sono state rimosse o modificate.
    // Il sito web (il frontend su Vercel) NON è il server di tracking (il backend su Pterodactyl).
    // Devi inserire l'indirizzo statico corretto del tuo server qui:
    ...
    this._webSocket = new WebSocket(TRACKER_ADDRESS)
